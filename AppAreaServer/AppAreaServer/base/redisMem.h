...
class RedisMem
{
    ...
    public:
        ...
        Flyer::FlyerValue getSet(const char* table,const char *set,std::set<unsigned long> &retSet,const unsigned int cnt);
        Flyer::FlyerValue getSet(const char* table,const char *set,std::set<unsigned long> &retSet);
